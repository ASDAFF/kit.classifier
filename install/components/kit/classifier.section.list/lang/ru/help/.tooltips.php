...
$MESS ['LOW_DEPTH_TIP'] = "Число определяет начальный уровень вложенности разделов каталога, с которого будут выводится названия разделов.";
$MESS ['TOP_DEPTH_TIP'] = "Число определяет количество отображаемых уровней вложенности разделов каталога от начального уровня.";
?>