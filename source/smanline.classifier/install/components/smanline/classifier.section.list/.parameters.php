...
$rsIBlockStorage = CIBlock::GetList(Array("sort" => "asc"), Array("TYPE" => $arCurrentValues["IBLOCK_TYPE_STORAGE"], "ACTIVE"=>"Y"));

while($arr=$rsIBlockStorage->Fetch()) 
	$arIBlockStorage[$arr["ID"]] = "[".$arr["ID"]."] ".$arr["NAME"];	
unset($arr);
...
$arComponentParameters = array(
	"GROUPS" => array(
            "A_CLASSIFIER" => array(
                "NAME" => GetMessage("CLASSIFIER_GROUP_NAME"),
                "SORT" => "1",
            ),
            "A_GOODS" => array(
                "NAME" => GetMessage("GOODS_GROUP_NAME"),
                "SORT" => "2",
            ),
        ), 
	"PARAMETERS" => array(
		...
		"IBLOCK_ID_STORAGE" => array(
			"PARENT" => "A_GOODS",
			"NAME" => GetMessage("CP_BCSL_IBLOCK_ID"),
			"TYPE" => "LIST",
			"ADDITIONAL_VALUES" => "Y",
			"VALUES" => $arIBlockStorage,
			"REFRESH" => "Y",
		),		
		"SECTION_ID_STORAGE" => array(
			"PARENT" => "A_GOODS",
			"NAME" => GetMessage("CP_BCSL_SECTION_ID"),
			"TYPE" => "STRING",
			"DEFAULT" => '',
		),
		"SECTION_CODE_STORAGE" => array(
			"PARENT" => "A_GOODS",
			"NAME" => GetMessage("CP_BCSL_SECTION_CODE"),
			"TYPE" => "STRING",
			"DEFAULT" => '',
		),
		"PROPERTY_CLASSIFIER_NAME" => array(
			"PARENT" => "A_GOODS",
			"NAME" => GetMessage("CP_BCSL_PROPERTY_CLASSIFIER_NAME"),
			"TYPE" => "STRING",
			"DEFAULT" => 'categ_id',
		),        
		"SECTION_CODE_STORAGE" => array(
		...
		"NOT_SHOW_NULL_ELEMENTS" => array(
			"PARENT" => "DATA_SOURCE",
			"NAME" => GetMessage("CP_BCSL_NOT_SHOW_NULL_ELEMENTS"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => 'Y',
		),                
		"LOW_DEPTH" => array(
			"PARENT" => "DATA_SOURCE",
			"NAME" => GetMessage("CP_BCSL_LOW_DEPTH"),
			"TYPE" => "STRING",
			"DEFAULT" => '1',
		),
		"TOP_DEPTH" => array(
